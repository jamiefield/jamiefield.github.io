...
## Software and meta-analysis tools
   * <a href="http://jamiefield.github.io/files/Bosco_multi-purpose_meta-analysis.xlsm?dl=0">Frank Bosco's (VCU) Hunter and Schmidt meta-analysis software</a>
      * <ul><li>Frank's software is very easy to use and has been cited in several papers</li></ul>
   ...
   * <a href="https://metabus.org">Link to the metaBUS database</a><br>
      * The following are unique identifiers for common bivariate relations in IO/OB/HR research (i.e., taxonomic pairs) that can be used to demonstrate metaBUS's "targeted meta-analysis" function:
         * 20072 (Job satisfaction) || 40055 (Individual job performance)
         * 20438 (Conscientiousness) || 10199 (Organizational citizenship behavior)
         * 20432 (State stress) || 20227 (Absenteeism/Tardiness)
