...
## Presentation materials
   * <a href="http://jamiefield.github.io/files/A meta presentation2.pdf?dl=0">Link to PowerPoint presentation</a><br>
      * Note that the linked file is a PDF. If you want the .pptx version, please <a href = "mailto: james.field2@mail.wvu.edu">email me</a> <br> 
...
## Potentially helpful articles and other materials
   ...
   * <a href="http://jamiefield.github.io/files/Field (2005). Metaanalysis of correlation coefficients.pdf?dl=0">Field (2005). Meta-analysis of correlation coefficients [Excellent article for learning what goes on under the hood of a meta-analysis].</a><br>
