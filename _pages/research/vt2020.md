...
## Software and meta-analysis tools
   ...
   * <a href="http://jamiefield.github.io/files/McDaniel R psychometric meta-analysis program.R?dl=0">Annotated R code that conducts a psychometric meta-analysis </a>
      * My old adviser, Mike McDaniel, prepared this script.
```
...
```
   ...
   * <a href="https://metabus.org">Link to the metaBUS database</a><br>
      * The following are unique identifiers for common bivariate relations in IO/OB/HR research (i.e., taxonomic pairs) that can be used to demonstrate metaBUS's "targeted meta-analysis" function:
         * Tax ID 1: 20072 (Job satisfaction); Tax ID 2: 40055 (Individual job performance)
         * Tax ID 1: 20438 (Conscientiousness); Tax ID 2: 10199 (Organizational citizenship behavior)
         * Tax ID 1: 20432 (State stress); Tax ID 2: 20227 (Absenteeism/Tardiness)
